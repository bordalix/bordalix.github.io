...
;(function (X, N) {
  ...
  N(m, 'Core/Utilities.js', [m['Core/Globals.js']], function (f) {
    ...
    var a = (f.css = function (b, k) {
      ...
      Q = (f.normalizeTickInterval = function (b, k, a, u, H) {
        ...
        for (
          u = 0;
          u < k.length && !((c = k[u]), (H && c * a >= b) || (!H && d <= (k[u] + (k[u + 1] || k[u])) / 2));
          u++
        );
      ...
      R = (f.numberFormat = function (b, k, t, a) {
        ...
        if (-1 === k) k = Math.min(H, 20)
          ...
          0 <= d
            ...
            : ((c[0] = c[0].split('.')[0] || 0), (b = 20 > k ? (c[0] * Math.pow(10, c[1])).toFixed(k) : 0), (c[1] = 0))
        }
          ...
          t.target ||
            ...
            (function (k, a) {
              ...
              var c = 0,
                ...
                d = k.length + a.length
              for (u = 0; u < d; u++)
                !1 === (k[c] ? (a[H] ? (k[c].order <= a[H].order ? k[c++] : a[H++]) : k[c++]) : a[H++]).fn.call(b, t) &&
                  t.preventDefault()
            ...
            for (var I = 0; I < f.length; I++) {
              for (var v = h[I], x = f[I], D = [], n = 0; n < x.length; n++) {
                var l = v[n],
                  J = x[n]
                D[n] =
                  'number' === typeof l && 'number' === typeof J && ('A' !== x[0] || (4 !== n && 5 !== n))
                    ? l + e * (J - l)
                    : J
              }
              y.push(D)
      ...
      h.prototype.run = function (h, C, y) {
        ...
        h !== C || this.elem['forceAnimate:' + this.prop]
          ...
          : (delete I.curAnim[this.prop],
            I.complete && 0 === Object.keys(I.curAnim).length && I.complete.call(this.elem))
      }
      ...
      var v = (h.animObject = function (l) {
        ...
        D = (h.animate = function (l, v, w) {
          ...
          e(v, function (a, p) {
            ...
            g = null
            'd' === p && L(v.d)
              ? ((c.paths = c.initPath(l, l.pathArray, v.d)), (c.toD = v.d), (r = 0), (g = 1))
              : l.attr
              ? (r = l.attr(p))
  ...
  N(
    ...
    [m['Core/Animation/AnimationUtilities.js'], m['Core/Color/Color.js'], m['Core/Globals.js'], m['Core/Utilities.js']],
    function (f, h, m, z) {
      var F = f.animate,
        P = f.animObject,
        K = f.stop,
      ...
      f = (function () {
        ...
        E.prototype.align = function (a, b, k) {
          ...
          var p, q
          if (a) {
            if (((this.alignOptions = a), (this.alignByTranslate = b), !k || B(k)))
              (this.alignTo = t = k || 'renderer'), d(g, this), g.push(this), (k = void 0)
          ...
          c(this.renderer, 'complexColor', { args: arguments }, function () {
            ...
            if (d) {
              ...
              'radialGradient' === d &&
                w &&
                !r(g.gradientUnits) &&
                ((p = g), (g = A(g, t.getRadialAttr(w, p), { gradientUnits: 'userSpaceOnUse' })))
              G(g, function (b, k) {
                'id' !== k && V.push(k, b)
              })
              G(B, function (b) {
              ...
              if (q[V]) E = q[V].attr('id')
                ...
                B.forEach(function (b) {
                  0 === b[1].indexOf('rgba')
                    ? ((H = h.parse(b[1])), (l = H.get('rgb')), (n = H.get('a')))
                    : ((l = b[1]), (n = 1))
        ...
        E.prototype.getBBox = function (a, b) {
          ...
          if (!k) {
            ...
            t.isSVG &&
              ...
              b &&
                ((d = b * C),
                (k.width = Math.abs(t * Math.sin(d)) + Math.abs(a * Math.cos(d))),
                (k.height = Math.abs(t * Math.cos(d)) + Math.abs(a * Math.sin(d)))))
            if (n && 0 < k.height) {
            ...
            ? ((c.ontouchstart = function (b) {
              ...
              (c.ontouchend = function (a) {
                ;(k &&
                  4 <=
                    Math.sqrt(
                      Math.pow(k - a.changedTouches[0].clientX, 2) + Math.pow(t - a.changedTouches[0].clientY, 2)
                    )) ||
                  b.call(c, a)
                d = !0
        ...
        E.prototype.setTextPath = function (a, b) {
          ...
          if (a && b && b.enabled) {
            d && null === d.element.parentNode
              ? ((g = !0), (d = d.destroy()))
              : d && this.removeTextOutline.call(d.parentGroup, [].slice.call(k.getElementsByTagName('tspan')))
        ...
        E.prototype.textSetter = function (a) {
          a !== this.textStr &&
            (delete this.textPxLength, (this.textStr = a), this.added && this.renderer.buildText(this))
        }
        ...
        E.prototype.zIndexSetter = function (a, b) {
          ...
          var q
          r(a)
            ? (d.setAttribute('data-z-index', a), (a = +a), this[b] === a && (p = !1))
    ...
    function (f, h) {
      ...
      return (function (h) {
        ...
        e.prototype.alignSetter = function (e) {
          ...
          e !== this.alignFactor &&
            ((this.alignFactor = e), this.bBox && L(this.xSetting) && this.attr({ x: this.xSetting }))
        }
          ...
          if (n) {
            var l = function (l) {
              ;(('mouseenter' === e || 'mouseleave' === e) &&
                ...
                (h.element.contains(l.relatedTarget) || n.element.contains(l.relatedTarget))) ||
                v.call(h.element, l)
            }
            n.on(e, l)
          }
        ...
        e.prototype.updateBoxSize = function () {
          var f = this.text.element.style,
            ...
            D = this.paddingLeft,
            n =
              (L(this.widthSetting) && L(this.heightSetting) && !this.textAlign) || !z(this.text.textStr)
                ? e.emptyBBox
                : this.text.getBBox()
          this.width = (this.widthSetting || n.width || 0) + 2 * h + D
          this.height = (this.heightSetting || n.height || 0) + 2 * h
          this.baselineOffset =
            h + Math.min(this.renderer.fontMetrics(f && f.fontSize, this.text).b, n.height || Infinity)
          this.needsBox &&
            (this.box ||
        ...
        e.prototype.updateTextPadding = function () {
          ...
          z(this.widthSetting) &&
            ...
            (h += { center: 0.5, right: 1 }[this.textAlign] * (this.widthSetting - this.bBox.width))
          if (h !== e.x || f !== e.y)
            e.attr('x', h),
              e.hasBoxWidthChanged && ((this.bBox = e.getBBox(!0)), this.updateBoxSize()),
        ...
        e.prototype.xSetter = function (e) {
          this.x = e
          this.alignFactor &&
            ((e -= this.alignFactor * ((this.widthSetting || this.bBox.width) + 2 * this.padding)),
        ...
        E = (function () {
          ...
          u.prototype.buildText = function (b) {
            ...
            var O = function (b) {
                var t
                a.styledMode ||
                  (t = /(px|em)$/.test(b && b.style.fontSize) ? b.style.fontSize : h || a.style.fontSize || 12)
              ...
              x = function (b, k) {
                ...
                a = b.indexOf(k + '=')
                if (-1 !== a && ((a = a + k.length + 1), (k = b.charAt(a)), '"' === k || "'" === k))
                            ...
                            if (V)
                              ...
                              for (; w.length; )
                                w.length &&
                                  ...
                                  K(u, { dy: r, x: B }),
                                  n && K(u, 'style', n),
                                  u.appendChild(p.createTextNode(w.join(' ').replace(/- /g, '-'))),
                                  k.appendChild(u)),
          ...
          u.prototype.button = function (b, k, a, c, d, g, p, q, u, n) {
            ...
            t.setState = function (b) {
              1 !== b && (t.state = H = b)
              t.removeClass(/highcharts-button-(normal|hover|pressed|disabled)/).addClass(
          ...
          u.prototype.image = function (b, k, a, c, d, g) {
            ...
            g
              ? (p(H.element, 'data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='),
                (t = new O.Image()),
                P(t, 'load', q),
                (t.src = b),
                t.complete && q({}))
          ...
          u.prototype.symbol = function (b, k, t, c, d, g) {
            ...
            if (n) {
              'number' === typeof k &&
                (A = n.call(this.symbols, Math.round(k || 0), Math.round(t || 0), c || 0, d || 0, g))
              var B = this.path(A)
                ...
                B[b + 'Setter'] = function (b, k) {
                  ...
                  e(t) &&
                    (g &&
                      ...
                      this.width &&
                      this.height &&
                      (t = Math.round(t * Math.min(this.width / this.imgwidth, this.height / this.imgheight))),
          ...
          u.prototype.fontMetrics = function (b, k) {
            b =
              (!this.styledMode && /px/.test(b)) || !O.getComputedStyle
                ? b || (k && k.style && k.style.fontSize) || (this.style && this.style.fontSize)
          ...
          u.prototype.pathToSegments = function (b) {
            for (
              var k = [], a = [], c = { A: 8, C: 7, H: 2, L: 3, M: 3, Q: 5, S: 5, T: 3, V: 2 }, d = 0;
              d < b.length;
              d++
            )
              l(a[0]) &&
                ...
                'string' === typeof b[d] && (a.length && k.push(a.slice(0)), (a.length = 0)),
                a.push(b[d])
            k.push(a.slice(0))
            return k
          }
      ...
      E.prototype.symbols = {
        ...
        arc: function (a, b, k, t, c) {
          ...
          if (c) {
            ...
            e(t) &&
              d.push(H ? ['M', a + t * n, b + t * A] : ['L', a + t * n, b + t * A], [
                'A',
                t,
                t,
                0,
  ...
  N(
    ...
    [m['Core/Globals.js'], m['Core/Renderer/SVG/SVGElement.js'], m['Core/Utilities.js']],
    function (f, h, m) {
      var z = m.css,
        F = m.defined,
        P = m.extend,
          ...
          if (this.added) {
            ...
            if ('SPAN' === f.tagName) {
              ...
              ;(c = d !== this.oldTextWidth) &&
                !(c = d > this.oldTextWidth) &&
                ((c = this.textPxLength) || (z(f, { width: '', whiteSpace: r || 'nowrap' }), (c = f.offsetWidth)),
                (c = c > d))
              c && (/[ \-]/.test(f.textContent || f.innerText) || 'ellipsis' === f.style.textOverflow)
                ? (z(f, { width: d + 'px', display: 'block', whiteSpace: r || 'normal' }),
                  (this.oldTextWidth = d),
  ...
  N(m, 'Core/Axis/Tick.js', [m['Core/Globals.js'], m['Core/Utilities.js']], function (f, h) {
    ...
    h = (function () {
      ...
      f.prototype.addLabel = function () {
        ...
        if ((h = D && D.list))
          n.shortenLabel = function () {
            for (f = 0; f < h.length; f++)
              if (
                (A.attr({ text: l.labelFormatter.call(K(n.formatCtx, { dateTimeLabelFormat: h[f] })) }),
        ...
        F(A) || n.movedLabel
          ? A &&
            A.textStr !== e &&
            !r &&
            (!A.textWidth || (a.style && a.style.width) || A.styles.width || A.css({ width: null }),
            A.attr({ text: e }),
      ...
      f.prototype.createLabel = function (n, l, f) {
        var w = this.axis,
          r = w.chart
        if ((n = F(l) && f.enabled ? r.renderer.text(l, n.x, n.y, f.useHTML).add(w.labelGroup) : null))
          r.styledMode || n.css(e(f.style)), (n.textPxLength = n.getBBox().width)
        return n
      }
      ...
      f.prototype.getPosition = function (n, l, e, w) {
        ...
        n = {
          x: n
            ...
            : r.left + r.offset + (r.opposite ? ((w && d.oldChartWidth) || d.chartWidth) - r.right - r.left : 0),
          y: n
        ...
        F(f) ||
          (f =
            0 === a.side
              ...
              : 2 === a.side
              ? A.y + 8
              : Math.cos(e.rotation * x) * (A.y - e.getBBox(!1, 0).height / 2))
      ...
      f.prototype.handleOverflow = function (n) {
        ...
        if (a || 'justify' !== v(f.overflow, 'justify'))
          0 > a && w - q * p < g
            ...
            : 0 < a && w + q * p > d && (h = Math.round((r - w) / Math.cos(a * x)))
        else if (
          ((r = w + (1 - q) * p),
        ...
        w && w.textStr === n
          ...
          : I(d.ticks, function (a) {
              r ||
                ...
                !a.label ||
                a.label.textStr !== n ||
                ((l.movedLabel = a.label), (r = !0), (a.labelPos = l.movedLabel.xy), delete a.label)
            })
        if (!r && (l.labelPos || w)) {
        ...
        d ||
          ...
          (this.gridLine = d =
            p
              ...
              .add(l.gridGroup)))
        if (d && (f = l.getPlotLinePath({ value: c + q, lineWidth: d.strokeWidth() * f, force: 'pass', old: n })))
      ...
      f.prototype.renderLabel = function (e, l, f, w) {
        ...
        c &&
          ...
          (this.isLast && !this.isFirst && !v(g.showLastLabel, 1))
            ? (p = !1)
            : !d || a.step || a.rotation || l || 0 === f || this.handleOverflow(e),
          q && w % q && (p = !1),
          p && y(e.y)
            ? ((e.opacity = f), c[this.isNewLabel ? 'attr' : 'animate'](e), (this.isNewLabel = !1))
      ...
      f = (function () {
        ...
        u.prototype.setOptions = function (b) {
          this.options = q(
            ...
            [u.defaultTopAxisOptions, u.defaultRightAxisOptions, u.defaultBottomAxisOptions, u.defaultLeftAxisOptions][
              this.side
            ],
            q(O[this.coll], b)
          )
        ...
        u.prototype.defaultLabelFormatter = function () {
          ...
          if (u) var A = w(u, this, B)
            ...
            for (; e-- && 'undefined' === typeof A; )
              (a = Math.pow(p, e + 1)),
                b >= a && 0 === (10 * k) % a && null !== q[e] && 0 !== k && (A = l(k / a, -1) + q[e])
        ...
        u.prototype.translate = function (b, a, t, d, g, p) {
          ...
          a
            ...
            : (g && (b = k.val2lin(b)), (b = c(d) ? q * (b - d) * H + e + q * u + (c(p) ? H * p : 0) : void 0))
          return b
        }
        ...
        u.prototype.getMinorTickPositions = function () {
          ...
          if (q && q / c < this.len / 3) {
            ...
            if (e)
              ...
              d = d.concat(this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(c), p, g, b.startOfWeek))
        ...
        u.prototype.setTickInterval = function (b) {
          ...
          g &&
            (a.positiveValuesOnly && !b && 0 >= Math.min(a.min, A(a.dataMin, a.min)) && n(10, 1, d),
            (a.min = v(g.log2lin(a.min), 16)),
            (a.max = v(g.log2lin(a.max), 16)))
          a.range &&
            x(a.max) &&
            ((a.userMin = a.min = O = Math.max(a.dataMin, a.minFromRange())), (a.userMax = D = a.max), (a.range = null))
          J(a, 'foundExtremes')
          a.beforePadding && a.beforePadding()
          a.adjustForMinRange()
          !(w || a.axisPointRange || (a.stacking && a.stacking.usePercentage) || u) &&
            x(a.min) &&
            x(a.max) &&
            (d = a.max - a.min) &&
          ...
          E &&
            ...
            !x(O) && a.min < G && a.dataMin >= G
              ? (a.min = a.options.minRange ? Math.min(G, a.max - a.minRange) : G)
              : !x(D) &&
                a.max > G &&
                a.dataMax <= G &&
                (a.max = a.options.minRange ? Math.max(G, a.min + a.minRange) : G))
          a.tickInterval =
          ...
          a.dateTime ||
            ...
            (a.tickInterval = p(
              ...
              void 0,
              r(a.tickInterval),
              A(q.allowDecimals, 0.5 > a.tickInterval || void 0 !== this.tickAmount),
              !!this.tickAmount
            ))
        ...
        u.prototype.setTickPositions = function () {
          ...
          g = (p || !g) && b.endOnTick
          this.tickmarkOffset =
            this.categories && 'between' === b.tickmarkPlacement && 1 === this.tickInterval ? 0.5 : 0
        ...
        u.prototype.zoom = function (b, a) {
          ...
          J(this, 'zoom', b, function (b) {
            ...
            if (a !== k.min || g !== k.max)
              k.allowZoomOutside ||
                (x(c) && (a < p && (a = p), a > q && (a = q)), x(d) && (g < p && (g = p), g > q && (g = q))),
        ...
        u.prototype.getTitlePosition = function () {
          ...
          a =
            (b ? c + this.height : a) + (b ? 1 : -1) * (q ? -1 : 1) * this.axisTitleMargin + [-l, l, r.f, -l][this.side]
        ...
        u.prototype.renderTick = function (b, a) {
          ...
          if (!d || (b >= this.min && b <= this.max) || (null === (k = this.grid) || void 0 === k ? 0 : k.isColumn))
            g[b] || (g[b] = new z(this, b)), p && g[b].isNew && g[b].render(a, !0, -1), g[b].render(a)
        }
        u.prototype.render = function () {
          ...
          h &&
            (h[h.isPlaced ? 'animate' : 'attr']({ d: this.getLinePath(h.strokeWidth()) }),
            (h.isPlaced = !0),
            h[G ? 'show' : 'hide'](G))
          e &&
            G &&
            ((g = b.getTitlePosition()),
            c(g.y) ? (e[e.isNew ? 'attr' : 'animate'](g), (e.isNew = !1)) : (e.attr('y', -9999), (e.isNew = !0)))
        ...
        u.prototype.drawCrosshair = function (b, a) {
          ...
          if (this.crosshair && !1 !== (x(a) || !k)) {
            k
              ? x(a) &&
                (d = A('colorAxis' !== this.coll ? a.crosshairPos : null, this.isXAxis ? a.plotX : this.len - a.plotY))
              : (d = b && (this.horiz ? b.chartX - this.pos : this.len - b.chartY + this.pos))
            if (x(d)) {
            ...
            g ||
              ...
              p.styledMode ||
                (g
                  .attr({
                    stroke: c.color || (k ? h.parse('#ccd6eb').setOpacity(0.25).get() : '#cccccc'),
        ...
        u.prototype.hasVerticalPanning = function () {
          var b, a
          return /y/.test(
            (null === (a = null === (b = this.chart.options.chart) || void 0 === b ? void 0 : b.panning) || void 0 === a
              ? void 0
              : a.type) || ''
          )
        }
      ...
      K = (function () {
        ...
        f.prototype.normalizeTimeTickInterval = function (f, e) {
          ...
          for (
            D = 0;
            D < h.length &&
            !((e = h[D]), (v = L[e[0]]), (x = e[1]), h[D + 1] && f <= (v * x[x.length - 1] + L[h[D + 1][0]]) / 2);
            D++
          );
      ...
      K = (function () {
        ...
        f.prototype.getLogTickPositions = function (f, e, h, v) {
          ...
          if (0.5 <= f) (f = Math.round(f)), (l = x.getLinearTickPositions(f, e, h))
            ...
            var m, w
            for (
              D = 0.3 < f ? [1, 2, 4] : 0.15 < f ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9];
              n < h + 1 && !w;
              n++
            ) {
              var r = D.length
            ...
            (e = this.lin2log(e)),
              ...
              (f = L(
                ...
                ((n.tickPixelInterval / (v ? 5 : 1)) * (h - e)) / ((v ? D / x.tickPositions.length : D) || 1)
              )),
              (f = F(f, void 0, z(f))),
        ...
        f.prototype.render = function () {
          ...
          n.chart.styledMode ||
            (p
              ...
              : q &&
                ((G.fill = M || '#e6ebf5'),
                w.borderWidth && ((G.stroke = w.borderColor), (G['stroke-width'] = w.borderWidth))))
          O.zIndex = x
          u += '-' + x
          ...
          ;(A || !B.d) && G && G.length
            ? B.attr({ d: G })
            : B && (G ? (B.show(!0), B.animate({ d: G })) : B.d && (B.hide(), d && (f.label = d = d.destroy())))
          ...
          if (n && l) {
            ...
            for (e = 0; e < n.length; e += 2) {
              ...
              ;('M' !== f[0] && 'L' !== f[0]) ||
                ...
                ('M' !== c[0] && 'L' !== c[0]) ||
                ('M' !== a[0] && 'L' !== a[0]) ||
                (w && c[1] === f[1] ? ((c[1] += r), (a[1] += r)) : w || c[2] !== f[2] || ((c[2] += r), (a[2] += r)),
                h.push(['M', f[1], f[2]], ['L', g[1], g[2]], ['L', a[1], a[2]], ['L', c[1], c[2]], ['Z']))
              h.isFlat = d
            }
          }
          return h
    ...
    var w = (function () {
      ...
      r.prototype.bodyFormatter = function (d) {
        return d.map(function (d) {
          ...
          return (c[(d.point.formatPrefix || 'point') + 'Formatter'] || d.point.tooltipFormatter).call(
            d.point,
      ...
      r.prototype.getAnchor = function (d, g) {
        ...
        this.followPointer && g
          ...
          : (d.forEach(function (a) {
            ...
            (d = [
              q ? c.plotWidth - l : f,
              this.shared && !q && 1 < d.length && g ? g.chartY - p : q ? c.plotHeight - f : l,
            ]))
      ...
      r.prototype.getLabel = function () {
        var d,
          ...
          l =
            (null === (d = p.style) || void 0 === d ? void 0 : d.pointerEvents) ||
        ...
        if (!this.label) {
          this.outside &&
            ...
            (this.renderer = a =
              new f.Renderer(
                ...
                0,
                0,
                null === (g = this.chart.options.chart) || void 0 === g ? void 0 : g.style,
                void 0,
                void 0,
                a.styledMode
              )))
          this.split
            ? (this.label = a.g(e))
            : ((this.label = a
                .label('', 0, 0, p.shape || 'callout', null, null, p.useHTML, null, e)
          ...
          b = function (b) {
            ...
            return [b, k ? r : n, k ? d : g].concat(
              l
                ? [
                    k ? E(d) : u(g),
                    k ? h.left - q + E(c.plotX + a.plotLeft) : h.top - q + u(c.plotY + a.plotTop),
                    0,
                    k ? r : n,
                  ]
                : [
            ...
            : (this.split
                ...
                : ((d = this.getLabel()),
                  ...
                  d
                    ...
                    .addClass('highcharts-color-' + D(q.colorIndex, f.colorIndex)),
      ...
      r.prototype.renderSplit = function (d, g) {
        function c(b, a, c, d, g) {
          ...
          c
            ...
            : ((a -= y), (b = g ? b - d - k : b + k), (b = z(b, g ? b : m.left, m.right)))
          return { x: b, y: a }
        }
        var a = this,
          q = a.chart,
          ...
          if (!1 !== p && '' !== p) {
            ...
            if (q.isHeader) {
              ...
              (B = v.xAxis),
                ...
                v.pos + E >= u + r && v.pos + E <= u + r + e - O && (G = v.pos + E)
      ...
      r.prototype.drawTracker = function () {
        if (this.followPointer || !this.options.stickOnContact) this.tracker && this.tracker.destroy()
          ...
          if (g && c) {
            ...
            a.height =
              0 > c[1] ? Math.max(Math.abs(c[1]), q.height - Math.abs(c[1])) : Math.max(Math.abs(c[1]), q.height)
            this.tracker
              ? this.tracker.attr(a)
              : ((this.tracker = g.renderer.rect(a).addClass('highcharts-tracker').add(g)),
      ...
      r.prototype.updatePosition = function (d) {
        ...
        if (this.outside) {
          ...
          if ((g = g.containerScaling))
            F(this.container, { transform: 'scale(' + g.scaleX + ', ' + g.scaleY + ')' }),
              (q *= g.scaleX),
              (p *= g.scaleY)
          q += c.left - d.x
          p += c.top - d.y
  ...
  N(
    m,
    'Core/Pointer.js',
    [m['Core/Color/Color.js'], m['Core/Globals.js'], m['Core/Tooltip.js'], m['Core/Utilities.js']],
    function (f, h, m, z) {
      var F = f.parse,
        P = h.charts,
        K = h.noop,
      ...
      f = (function () {
        ...
        g.prototype.applyInactiveState = function (c) {
          ...
          this.chart.series.forEach(function (c) {
            ;-1 === a.indexOf(c)
              ...
              : c.options.inactiveOtherPoints && c.setAllPointsToState('inactive')
          })
        }
        ...
        g.prototype.drag = function (c) {
          ...
          if (!E || !E.touch)
            if (
              (g < n ? (g = n) : g > n + w && (g = n + w),
              e < h ? (e = h) : e > h + v && (e = h + v),
              (this.hasDragged = Math.sqrt(Math.pow(u - g, 2) + Math.pow(b - e, 2))),
              10 < this.hasDragged)
            ) {
        ...
        g.prototype.getHoverData = function (c, a, d, g, e, f) {
          ...
          n = n
            ...
            : d.filter(function (a) {
                return h.filter
                  ? h.filter(a)
                  : a.visible && !(!e && a.directTouch) && r(a.options.enableMouseTracking, !0) && a.stickyTracking
              })
          ...
          p &&
            (e && !a.noSharedTooltip
              ? ((n = d.filter(function (a) {
                  return h.filter
                    ? h.filter(a)
                    : a.visible && !(!e && a.directTouch) && r(a.options.enableMouseTracking, !0) && !a.noSharedTooltip
                })),
        ...
        g.prototype.onTrackerMouseOut = function (c) {
          ...
          if (
            !(
              ...
              (this.inClass(c, 'highcharts-series-' + a.index) && this.inClass(c, 'highcharts-tracker'))
            )
          )
            a.onMouseOut()
        }
        ...
        g.prototype.pinch = function (c) {
          ...
          'touchstart' === c.type
            ...
            : g.length &&
              (h || (a.selectionMarker = h = v({ destroy: K, touch: !0 }, d.plotBox)),
        ...
        g.prototype.runPointActions = function (c, a) {
          ...
          l = this.getHoverData(
            ...
            l,
            d.series,
            (!c || 'touchmove' !== c.type) && (!!a || (l && l.directTouch && this.isDirectTouch)),
            e,
            c
          )
          f = l.hoverPoint
        ...
        g.prototype.scaleGroups = function (c, a) {
          ...
          d.series.forEach(function (p) {
            ...
            p.xAxis &&
              ...
              p.group &&
              (p.group.attr(g),
              p.markerGroup && (p.markerGroup.attr(g), p.markerGroup.clip(a ? d.clipRect : null)),
        ...
        g.prototype.setDOMEvents = function () {
          ...
          h.hasTouch &&
            ...
            h.unbindDocumentTouchEnd ||
              (h.unbindDocumentTouchEnd = C(a, 'touchend', this.onDocumentTouchEnd.bind(this))))
        }
        ...
        g.prototype.touch = function (c, a) {
          ...
          if (1 === c.touches.length)
            if (
              ((c = this.normalize(c)),
              (g = d.isInsidePlot(c.chartX - d.plotLeft, c.chartY - d.plotTop)) && !d.openMenu)
            ) {
              a && this.runPointActions(c)
              if ('touchmove' === c.type) {
                a = this.pinchDown
                var e = a[0]
                  ? 4 <= Math.sqrt(Math.pow(a[0].chartX - c.chartX, 2) + Math.pow(a[0].chartY - c.chartY, 2))
                  : !1
              }
              r(e, !0) && this.pinch(c)
            } else a && this.reset()
      ...
      var r = h.marginNames,
        ...
        g = (function () {
          ...
          c.prototype.setOptions = function (a) {
            ...
            this.options = a
            this.chart.styledMode ||
              ((this.itemStyle = a.itemStyle), (this.itemHiddenStyle = D(this.itemStyle, a.itemHiddenStyle)))
            ...
            d.text &&
              (this.title ||
                ((this.title = this.chart.renderer
                  .label(d.text, c - 3, c - 4, null, null, null, a.useHTML, null, 'legend-title')
                  .attr({ zIndex: 1 })),
          ...
          c.prototype.renderItem = function (a) {
            ...
            v ||
              ...
              this.baseline ||
                ((this.fontMetrics = d.fontMetrics(c.styledMode ? 12 : l.fontSize, v)),
            ...
            ;(!c.styledMode && l.width) ||
              v.css({ width: (g.itemWidth || this.widthOption || c.spacingBox.width) - h + 'px' })
            this.setText(a)
            c = v.getBBox()
          ...
          c.prototype.layoutItem = function (a) {
            ...
            this.offsetWidth =
              this.widthOption || Math.max((g ? this.itemX - d - (a.checkbox ? 0 : r) : c) + d, this.offsetWidth)
          }
          c.prototype.getAllItems = function () {
            ...
            this.chart.series.forEach(function (c) {
              ...
              c &&
                ...
                (a = a.concat(c.legendItems || ('point' === d.legendType ? c.data : c)))
            })
          ...
          c.prototype.render = function () {
            ...
            h += f
            g ||
              ((this.box = g = c.rect().addClass('highcharts-legend-box').attr({ r: e.borderRadius }).add(d)),
              (g.isNew = !0))
            a.styledMode ||
              g
                .attr({ stroke: e.borderColor, 'stroke-width': e.borderWidth || 0, fill: e.backgroundColor || 'none' })
                .shadow(e.shadow)
            0 < r &&
              0 < h &&
              (g[g.isNew ? 'attr' : 'animate'](g.crisp.call({}, { x: 0, y: 0, width: r, height: h }, g.strokeWidth())),
              (g.isNew = !1))
            g[n ? 'show' : 'hide']()
          ...
          c.prototype.align = function (a) {
            ...
            ;/(lth|ct|rth)/.test(this.getAlignment()) && 0 < c.titleOffset[0]
              ? (g += c.titleOffset[0])
              : /(lbh|cb|rbh)/.test(this.getAlignment()) && 0 < c.titleOffset[2] && (g -= c.titleOffset[2])
            g !== a.y && (a = D(a, { y: g }))
            this.group.align(
              D(d, {
          ...
          c.prototype.handleOverflow = function (a) {
            ...
            var r = e.maxHeight,
              ...
              D = function (a) {
                ...
                c.contentGroup.div &&
                  (c.contentGroup.div.style.clip = a ? 'rect(' + l + 'px,9999px,' + (l + a) + 'px,0)' : 'auto')
              },
              x = function (a) {
                c[a] = g
                  .circle(0, 0, 1.3 * b)
    ...
    function (f, h, m) {
      ...
      f = (function () {
        ...
        f.prototype.applyOptions = function (e, d) {
          ...
          this.formatPrefix = (this.isNull = n(this.isValid && !this.isValid(), null === this.x || !v(this.y)))
            ? 'null'
            : 'point'
        ...
        f.prototype.optionsToObject = function (e) {
          ...
          if (v(e) || null === e) d[a[0]] = e
            ...
            for (
              !c &&
              e.length > l &&
              ((g = typeof e[0]), 'string' === g ? (d.name = e[0]) : 'number' === g && (d.x = e[0]), p++);
              n < l;

            )
              (c && 'undefined' === typeof e[p]) ||
                (0 < a[n].indexOf('.') ? f.prototype.setNestedProperty(d, e[p], a[n]) : (d[a[n]] = e[p])),
                p++,
                n++
          else
            'object' === typeof e &&
              ((d = e), e.dataLabels && (g._hasPointLabels = !0), e.marker && (g._hasPointMarkers = !0))
          return d
        }
        ...
        f.cleanRecursively = function (h, m) {
          ...
          e(h, function (e, l) {
            if (C(h[l], !0) && !h.nodeType && m[l])
              (e = f.cleanRecursively(h[l], m[l])), Object.keys(e).length && (v[l] = e)
        ...
        W = (function () {
            ...
            d.forEach(function (a) {
              a.isDirty &&
                ('point' === a.options.legendType
                  ? ('function' === typeof a.updateTotals && a.updateTotals(), (f = !0))
          ...
          f.prototype.layOutTitles = function (a) {
            ...
            ;['title', 'subtitle', 'caption'].forEach(function (a) {
              ...
              if (g) {
                ...
                k.floating ||
                  ('top' === e ? (b[0] = Math.ceil(b[0] + t)) : 'bottom' === e && (b[2] = Math.ceil(b[2] + t)))
              }
            }, this)
          ...
          f.prototype.getChartSize = function () {
            ...
            this.chartHeight = Math.max(
              0,
              U(a, this.chartWidth) || (1 < this.containerHeight ? this.containerHeight : 400)
            )
          }
            ...
            if (a)
              for (; b && b.style; )
                b.hcOrigStyle && (g(b, b.hcOrigStyle), delete b.hcOrigStyle),
                  b.hcOrigDetached && (n.body.removeChild(b), (b.hcOrigDetached = !1)),
                  (b = b.parentNode)
            else
              for (; b && b.style; ) {
          ...
          f.prototype.linkSeries = function () {
            ...
            b.forEach(function (b) {
              ...
              u(c) &&
                ...
                (b.visible = H(b.options.visible, c.options.visible, b.visible)))
            })
  ...
  N(
    ...
    [m['Core/Animation/AnimationUtilities.js'], m['Core/Chart/Chart.js'], m['Core/Globals.js'], m['Core/Utilities.js']],
    function (f, h, m, z) {
      var F = f.stop,
        L = z.addEvent,
        K = z.createElement,
      ...
      h.prototype.applyFixed = function () {
        ...
        h
          ? ((this.fixedDiv = K(
              ...
              { position: 'absolute', overflow: 'hidden', pointerEvents: 'none', zIndex: 2, top: 0 },
              null,
              !0
            )),
            ...
            (this.fixedRenderer = f =
              new m.Renderer(
                ...
                this.chartWidth,
                this.chartHeight,
                null === (e = this.options.chart) || void 0 === e ? void 0 : e.style
              )),
        ...
        y = (function () {
          ...
          e.prototype.renderStackTotals = function () {
            ...
            var n = (this.stackTotalGroup =
              this.stackTotalGroup || h.g('stack-labels').attr({ visibility: 'visible', zIndex: 6, opacity: 0 }).add())
  ...
  N(m, 'Mixins/LegendSymbol.js', [m['Core/Globals.js'], m['Core/Utilities.js']], function (f, h) {
    ...
    return (f.LegendSymbolMixin = {
      ...
      drawLineMarker: function (f) {
        ...
        var x = {}
        this.chart.styledMode ||
          ((x = { 'stroke-width': h.lineWidth || 0 }), h.dashStyle && (x.dashstyle = h.dashStyle))
        ...
        },
        {
          ...
          init: function (a, c) {
            ...
            G(e, function (a, c) {
              q(a) &&
                b.eventOptions[c] !== a &&
                (q(b.eventOptions[c]) && T(b, c, b.eventOptions[c]), (b.eventOptions[c] = a), I(b, c, a))
            })
            if ((e && e.click) || (c.point && c.point.events && c.point.events.click) || c.allowPointSelect)
              a.runTrackerClick = !0
            b.getColor()
            b.getSymbol()
          ...
          autoIncrement: function () {
            ...
            g &&
              ...
              'day' === g
                ...
                : 'year' === g && e.set('FullYear', a, e.get('FullYear', a) + d),
              (d = a.getTime() - c))
            this.xIncrement = c + d
            return c
          },
          ...
          setOptions: function (a) {
            ...
            ;(!f.negativeColor && !f.negativeFillColor) ||
              f.zones ||
              ((d = { value: f[this.zoneAxis + 'Threshold'] || f.threshold || 0, className: 'highcharts-negative' }),
              b || ((d.color = f.negativeColor), (d.fillColor = f.negativeFillColor)),
              c.push(d))
          ...
          getColor: function () {
            this.chart.styledMode
              ...
              : this.getCyclic('color', this.options.color || e.plotOptions[this.type].color, this.chart.options.colors)
          },
              ...
              if (f.id || p(t)) {
                if (
                  ...
                  -1 === t || 'undefined' === typeof t
                    ? k.push(a)
                    : g[t] && a !== b.data[t]
                    ? (g[t].update(a, !1, null, !1), (g[t].touched = !0), q && (h = t + 1))
                    : g[t] && (g[t].touched = !0),
              ...
              if (n && t > n)
                if (((n = k.getFirstValidPoint(b)), p(n)))
                  ...
                  if (A) for (d = 0; d < t; d++) (g = b[d]), (r[d] = g[0]), (m[d] = g.slice(1, A + 1))
                    ...
                    for (
                      v && ((E = v.indexOf('x')), (H = v.indexOf('y')), (E = 0 <= E ? E : 0), (H = 0 <= H ? H : 1)),
                        d = 0;
                      d < t;
                      d++
                    )
          ...
          getProcessedData: function (a) {
            ...
            for (p = b.length || 1; --p; )
              if (((d = f ? a(b[p]) - a(b[p - 1]) : b[p] - b[p - 1]), 0 < d && ('undefined' === typeof m || d < m)))
                var m = d
          ...
          generatePoints: function () {
            ...
            for (m = 0; m < h; m++) {
              ...
              if (n) {
                ...
                v.dataGroup.options &&
                  ((v.options = v.dataGroup.options), r(v, v.dataGroup.options), delete v.dataLabels)
          ...
          getClipBox: function (a, c) {
            ...
            a && !1 === b.clip && e
              ? (a = g
                  ...
                  : { y: -e.pos, height: d.chartHeight, width: d.chartWidth, x: -k.pos })
              : ((a = this.clipBox || d.clipBox),
                c && ((a.width = d.plotSizeX), (a.x = (d.scrollablePixelsX || 0) * (f.scrollPositionX || 0))))
          ...
          setClip: function (a) {
            ...
            if (!1 !== c.clip || a)
              this.group.clip(a || e ? l : b.clipRect), this.markerGroup.clip(h), (this.sharedClipKey = p)
            a ||
              (l.count[this.index] && (delete l.count[this.index], --l.count.length),
              0 === l.count.length &&
                p &&
                b[p] &&
                (e || (b[p] = b[p].destroy()), b[p + 'm'] && (b[p + 'm'] = b[p + 'm'].destroy())))
          },
          animate: function (a) {
            var b = this.chart,
                ...
                if (((l && 'undefined' === typeof n.enabled) || n.enabled) && !h.isNull && !1 !== h.visible) {
                  ...
                  g
                    ...
                    : w &&
                      ...
                      ((h.graphic = g = c.renderer.symbol(r, m.x, m.y, m.width, m.height, u ? n : e).add(f)),
                      this.enabledDataSorting && c.hasRendered && (g.attr({ x: h.startXPos }), (q = 'animate')))
          ...
          markerAttribs: function (a, c) {
            ...
            c &&
              ...
              (k = M(c && c.radius, d && d.radius, k + ((d && d.radiusPlus) || 0))))
          ...
          drawGraph: function () {
            ...
            e.forEach(function (b, e) {
              ...
              f
                ...
                : d.length && (a[k] = f = a.chart.renderer.path(d).addClass(b[1]).attr({ zIndex: 1 }).add(a.group))
              f &&
                !g &&
          ...
          applyZones: function () {
            ...
            if (g.length && (l || q) && u && 'undefined' !== typeof u.min) {
              ...
              g.forEach(function (b, g) {
                ...
                v = Math.max(e, f)
                u.isXAxis
                  ? ((h = { x: r ? v : w, y: 0, width: m, height: n }), G || (h.x = c.plotHeight - h.x))
                  : ((h = { x: 0, y: r ? v : w, width: n, height: m }), G && (h.y = c.plotWidth - h.y))
                r &&
                  d.isVML &&
                  (h = u.isXAxis
                    ? { x: 0, y: O ? w : v, height: h.width, width: c.chartWidth }
                    : { x: h.y - c.plotLeft - c.spacingBox.x, y: 0, width: h.height, height: c.chartHeight })
          ...
          invertGroups: function (a) {
            function b() {
              ;['group', 'markerGroup'].forEach(function (b) {
                c[b] &&
                  (d.renderer.isVML && c[b].attr({ width: c.yAxis.len, height: c.xAxis.len }),
          ...
          redraw: function () {
            ...
            d &&
              ...
              d.animate({ translateX: M(g && g.left, a.plotLeft), translateY: M(e && e.top, a.plotTop) }))
            this.translate()
            this.render()
        ...
        x = (function () {
          ...
          f.prototype.setOffset = function (f, h, m, w, r) {
            ...
            h &&
              ...
              g.isInsidePlot(h.alignAttr.x + c - this.alignOptions.x, h.alignAttr.y + m - this.alignOptions.y)
                ? h.show()
              ...
              I(!f && this.options.crop, !0) &&
                ((g = e(h.x) && e(h.y) && g.isInsidePlot(h.x - w + h.width, h.y) && g.isInsidePlot(h.x + w, h.y)) ||
                  h.hide()))
          }
      ...
      h.prototype.getStacks = function () {
        ...
        e.series.forEach(function (h) {
          ...
          !h.options.stacking ||
            ...
            (h.stackKey = [h.type, I(h.options.stack, ''), f ? l.top : l.left, f ? l.height : l.width].join())
        })
      }
      z.compose(f)
        ...
        if (f && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
          ...
          for (D = 0; D < r; D++) {
            ...
            'percent' === f
              ? ((G = G ? e : a),
                q && v[G] && v[G][y]
                  ? ((G = v[G][y]), (u.total = G.total = Math.max(G.total, u.total) + Math.abs(z) || 0))
    ...
    function (f, h, m, z, F, L, K, C, y, e) {
      ...
      F.cleanRecursively = function (a, c) {
        ...
        G(a, function (b, g) {
          if (p(a[g], !0) && !a.nodeType && c[g])
            (b = F.cleanRecursively(a[g], c[g])), Object.keys(b).length && (d[g] = b)
      ...
      g(z.prototype, {
        ...
        showLoading: function (a) {
          ...
          b ||
            ((c.loadingDiv = b =
              l('div', { className: 'highcharts-loading highcharts-loading-hidden' }, null, c.container)),
            (c.loadingSpan = l('span', { className: 'highcharts-loading-inner' }, null, b)),
            n(c, 'redraw', f))
          ...
          c.styledMode ||
            ...
            c.loadingShown ||
              ...
              I(b, { opacity: e.style.opacity || 0.5 }, { duration: e.showDuration || 0 })))
          c.loadingShown = !0
          f()
        },
          ...
          if (l && this.points) {
            ...
            this.points.forEach(function (a) {
              a &&
                ...
                !1 === B.showInLegend && a.legendItem && b.legend.destroyItem(a))
            }, this)
          }
          f.initialType = p
          b.linkSeries()
        ...
        { threshold: 0 },
        {
                  ...
                  f.push(l[a]),
                    [-1, 1].forEach(function (f) {
                      ...
                      if (v)
                        for (g = y; 0 <= g && g < r; )
                          (q = v.points[g]),
                            q || (g === y ? (l[a][p] = !0) : c[g] && (w = n[a].points[g]) && (m -= w[1] - w[0])),
                            (g += d)
          ...
          getGraphPath: function (e) {
            ...
            var c = function (a, c, f) {
              ...
              'undefined' !== typeof n &&
                (z.push({ plotX: q, plotY: null === n ? g : D.getThreshold(n), isNull: p, isCliff: !0 }),
                l.push({ plotX: q, plotY: null === v ? g : D.getThreshold(v), doCurve: !1 }))
            }
            e = e || this.points
            ...
            for (n = 0; n < e.length; n++) {
              ...
              if (!a || h)
                h || c(n, n - 1, 'left'),
                  (a && !m && h) || (z.push(e[n]), l.push({ x: n, plotX: q, plotY: p })),
                  h || c(n, n + 1, 'right')
            }
            n = f.call(this, z, !0, !0)
            l.reversed = !0
          ...
          drawGraph: function () {
            ...
            m.forEach(function (m) {
              var n = m[0],
                ...
                w = {}
              l
                ? ((l.endX = e.preventGraphAnimation ? null : f.xMap), l.animate({ d: f }))
  ...
  N(
    ...
    [m['Core/Series/Series.js'], m['Mixins/LegendSymbol.js'], m['Core/Options.js']],
    function (f, h, m) {
      ...
      h = h.seriesType(
        ...
        },
        {
          ...
          getColumnMetrics: function () {
            ...
            var n = Math.min(
                Math.abs(d.transA) *
                  ((d.ordinal && d.ordinal.slope) || f.pointRange || d.closestPointRange || d.tickInterval || 1),
                d.len
              ),
              m = n * f.groupPadding,
              v = (n - 2 * m) / (p || 1)
          ...
          translate: function () {
            ...
            f.points.forEach(function (g) {
              ...
              g.tooltipPos = h.inverted
                ? [a.len + a.pos - h.plotLeft - b, c.len + c.pos - h.plotTop - (t || 0) - y - w / 2, B]
          ...
          drawPoints: function () {
            ...
            e.points.forEach(function (h) {
              ...
              if (D(h.plotY) && null !== h.y) {
                ...
                p ||
                  ((h.graphic = p = g[h.shapeType](a).add(h.group || e.group)) &&
      ...
      f.seriesType(
        ...
        'line',
        {
          ...
          tooltip: {
            ...
            pointFormat: 'x: <strong>{point.x}</strong><br/>y: <strong>{point.y}</strong><br/>',
          },
        },
        {
          sorted: !1,
          ...
          drawGraph: function () {
            ;(this.options.lineWidth || (0 === this.options.lineWidth && this.graph && this.graph.strokeWidth())) &&
          ...
          animate: function (d) {
            ...
            d ||
              c.forEach(function (c) {
                ...
                d &&
                  e &&
                  (d.attr({ r: w(c.startR, g.center && g.center[3] / 2), start: a, end: a }),
                  d.animate({ r: e.r, start: e.start, end: e.end }, g.options.animation))
              })
          },
          hasData: function () {
          ...
          translate: function (d) {
            ...
            for (v = 0; v < x; v++) {
              ...
              y.labelPosition = {
                ...
                connectorPosition: {
                  breakAt: { x: d[0] + u + Math.cos(E) * z, y: d[1] + b + Math.sin(E) * z },
              ...
              if (!g.isNull && f) {
                ...
                g.delayedRendering
                  ? (f.setRadialReference(d.center).attr(l).attr(a),
                    e.styledMode || f.attr(h).attr({ 'stroke-linejoin': 'round' }).shadow(n, q),
          ...
          connectorShapes: {
            fixedOffset: function (d, e, c) {
              ...
              return [
                ['M', d.x, d.y],
                c.softConnector
                  ? ['C', d.x + ('left' === d.alignment ? -5 : 5), d.y, 2 * a.x - e.x, 2 * a.y - e.y, a.x, a.y]
                  : ['L', a.x, a.y],
                ['L', e.x, e.y],
              ]
            },
    ...
    function (f, h, m, z) {
      ...
      h.distribute = function (d, e, c) {
        ...
        for (
          ...
          for (f = d.length; f--; )
            (g = d[f]),
              (v = (Math.min.apply(0, g.targets) + Math.max.apply(0, g.targets)) / 2),
          ...
          for (g = !1; f--; )
            0 < f &&
              ...
              (d[f - 1].align = 0.5),
              d[f - 1].pos + d[f - 1].size > e && (d[f - 1].pos = e - d[f - 1].size),
              d.splice(f, 1),
              (g = !0))
        }
        n.push.apply(n, m)
      ...
      m.prototype.drawDataLabels = function () {
        ...
        h = e(
          e(
            a.options.plotOptions && a.options.plotOptions.series && a.options.plotOptions.series.dataLabels,
            a.options.plotOptions && a.options.plotOptions[c.type] && a.options.plotOptions[c.type].dataLabels
          ),
          h
        )
        ...
        if (x(h) || h.enabled || c._hasPointLabels) {
          ...
          !G &&
            (G = c.dataLabelsGroup) &&
            (c.visible && J.show(!0), G[f.animation ? 'animate' : 'attr']({ opacity: 1 }, z))
                ...
                a.styledMode ||
                  ...
                  'contrast' === r.color
                    ? ((g.contrastColor = C.getContrast(g.color || c.color)),
                      (r.color = (!y(m) && e.inside) || 0 > m || f.stacking ? g.contrastColor : '#000000'))
                    : delete g.contrastColor,
                  f.cursor && (r.cursor = f.cursor))
                var w = { r: e.borderRadius || 0, rotation: A, padding: e.padding, zIndex: 1 }
                a.styledMode ||
                  ((w.fill = e.backgroundColor), (w.stroke = e.borderColor), (w['stroke-width'] = e.borderWidth))
                n(w, function (a, b) {
              ...
              !k || (b && y(u))
                ? b &&
                  ...
                  (k
                    ...
                    : ((g.dataLabels = g.dataLabels || []),
                      (k = g.dataLabels[h] =
                        A
                          ? C.text(u, 0, -9999, e.useHTML).addClass('highcharts-data-label')
                          : C.label(u, 0, -9999, e.shape, null, null, e.useHTML, null, 'data-label')),
                      h || (g.dataLabel = k),
                      k.addClass(
                  ...
                  e.textPath &&
                    !e.useHTML &&
                    (k.setTextPath((g.getDataLabelPath && g.getDataLabelPath(k)) || g.graphic, e.textPath),
                    g.dataLabelPath && !e.textPath.enabled && (g.dataLabelPath = g.dataLabelPath.destroy())),
                ...
                : ((g.dataLabel = g.dataLabel && g.dataLabel.destroy()),
                  ...
                  p &&
                    ...
                    g.connectors && (1 === g.connectors.length ? delete g.connectors : delete g.connectors[h])))
            })
          })
        }
        ...
        var h = this,
          ...
          k =
            ...
            (d.series.forceDL ||
              (q && !b) ||
              u ||
              (c.inside && a && n.isInsidePlot(r, m ? a.x + 1 : a.y + a.height - 1, m)))
        var t = function (a) {
          ...
          x
            ? ((b = !1),
              ...
              (r = {
                ...
                y: a.y + (c.y || 0) + { top: 0, middle: 0.5, bottom: 1 }[c.verticalAlign] * a.height,
              }),
              t(r),
              ...
              'left' === y
                ...
                : 'right' === y && ((r.x -= w.width), (r.y -= t ? 0 : w.height)),
              (g.placed = !0),
              (g.alignAttr = r))
            : (t(a), g.align(c, null, a), (r = g.alignAttr))
          b && 0 <= a.height
            ? this.justifyDataLabel(g, c, r, w, a, f)
            : l(c.crop, !0) && (k = n.isInsidePlot(r.x, r.y) && n.isInsidePlot(r.x + w.width, r.y + w.height))
          if (c.shape && !x)
            g[f ? 'attr' : 'animate']({
      ...
      m.prototype.justifyDataLabel = function (d, e, c, a, f, h) {
        ...
        q = c.x + a.width - n
        q > g.plotWidth &&
          ('left' === p && 0 >= m ? ((e.align = 'right'), (e.inside = !0)) : (m += g.plotWidth - q), (v = !0))
        q = c.y + n
        0 > q && ('bottom' === l && 0 <= r ? ((e.verticalAlign = 'top'), (e.inside = !0)) : (r -= q), (v = !0))
        q = c.y + a.height - n
        q > g.plotHeight &&
          ('top' === l && 0 >= r ? ((e.verticalAlign = 'bottom'), (e.inside = !0)) : (r += g.plotHeight - q), (v = !0))
                ...
                for (P = 0; P < n; P++) {
                  ...
                  m &&
                    ...
                    ('undefined' === typeof c.distributeBox.pos
                      ? (N = 'hidden')
                      : ((F = c.distributeBox.size), (L = Y.radialDistributionY(c))))
                  ...
                  l(f.crop, !0) &&
                    ...
                    (A = null),
                    J - k < p && 1 === g
                      ? ((A = Math.round(k - J + p)), (S[3] = Math.max(A, S[3])))
                      : J + k > r - p && 0 === g && ((A = Math.round(J + k - r + p)), (S[1] = Math.max(A, S[1]))),
                    0 > L - F / 2
                      ? (S[0] = Math.max(Math.round(-L + F / 2), S[0]))
                      : L + F / 2 > v && (S[2] = Math.max(Math.round(L + F / 2 - v), S[2])),
                    (b.sideOverflow = A))
                }
              }
            }),
        ...
        (L.pie.prototype.verifyDataLabelOverflow = function (d) {
          ...
          if (!h) {
            ...
            null !== a[1]
              ...
              : ((l = C(l, f, e[2] - d[0] - d[2])), (e[1] += (d[0] - d[2]) / 2))
            l < e[2]
              ? ((e[2] = l),
    ...
    f.prototype.hideOverlappingLabels = function (f) {
      ...
      var C = function (d) {
        ...
        if (d && (!d.alignAttr || d.placed)) {
          ...
          var l = d.parentGroup
          d.width ||
            ((e = d.getBBox()), (d.width = e.width), (d.height = e.height), (e = m.fontMetrics(null, d.element).h))
          var n = d.width - 2 * c
          ;(f = { left: '0', center: '0.5', right: '1' }[d.alignValue])
            ? (a = +f * n)
            : L(d.x) && Math.round(d.x) !== d.translateX && (a = d.x - d.translateX)
          return {
                  ...
                  if (m) m[c ? 'animate' : 'attr']({ x: v.x, y: v.y })
                    ...
                    e &&
                      ((d.stateMarkerGraphic = m =
                        k.renderer.symbol(e, v.x, v.y, v.width, v.height).add(d.markerGroup)),
                      (m.currentSymbol = e))
      ...
      l(F.prototype, {
        ...
        setState: function (a, c) {
          ...
          if (
            ...
            if (f && !f.dashstyle)
              for (h = { 'stroke-width': l }, f.animate(h, n); d['zone-graph-' + e]; )
        ...
        setVisible: function (a, c) {
          var d = this,
            ...
            h = d.visible
          var l = (d.visible = a = d.options.visible = d.userOptions.visible = 'undefined' === typeof a ? !h : a)
            ? 'show'
            : 'hide'
      ...
      y !== (n && n.ruleIds) &&
        ...
        y
          ? ((n = this.currentOptions(h)),
            ...
            (this.currentResponsive = { ruleIds: y, mergedOptions: h, undoOptions: n }),
            this.update(h, f, !0))
      ...
      function f(e, l, m, v) {
        ...
        K(e, function (d, e) {
          if (!v && -1 < h.collectionsWithUpdate.indexOf(e))
            for (d = y(d), m[e] = [], n = 0; n < Math.max(d.length, l[e].length); n++)
