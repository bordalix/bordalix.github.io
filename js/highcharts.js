  ...
  Q(A, 'parts/Utilities.js', [A['parts/Globals.js']], function (d) {
    ...
    function q(a, c, k) {
      ...
      D(c)
        ? b(k)
          ? a.setAttribute(c, k)
          : a && a.getAttribute && ((r = a.getAttribute(c)) || 'class' !== c || (r = a.getAttribute(c + 'Name')))
        : Z(c, function (c, k) {
            a.setAttribute(k, c)
          })
      return r
    ...
    function K(a, c) {
      ...
      for (a = k.pop(); 'undefined' !== typeof a && 'undefined' !== typeof c && null !== c; ) (c = c[a]), (a = k.pop())
      return c
    }
    d.timers = []
    var J = d.charts,
              ...
              for (var e = 0; e < a.length; e++) {
                for (var z = c[e], b = a[e], g = [], l = 0; l < b.length; l++) {
                  var h = z[l],
                    P = b[l]
                  g[l] =
                    'number' === typeof h && 'number' === typeof P && ('A' !== b[0] || (4 !== l && 5 !== l))
                      ? h + r * (P - h)
                      : P
                }
                k.push(g)
      ...
      T = (d.numberFormat = function (a, c, k, r) {
        ...
        if (-1 === c) c = Math.min(z, 20)
          ...
          0 <= l
            ...
            : ((b[0] = b[0].split('.')[0] || 0), (a = 20 > c ? (b[0] * Math.pow(10, b[1])).toFixed(c) : 0), (b[1] = 0))
        }
    ...
    var ca = (d.getStyle = function (a, c, k) {
        ...
        if ('height' === c)
          return Math.max(
            0,
            Math.min(a.offsetHeight, a.scrollHeight) - d.getStyle(a, 'padding-top') - d.getStyle(a, 'padding-bottom')
          )
          ...
          k.target ||
            ...
            (function (c, r) {
              ...
              var e = 0,
                ...
                l = c.length + r.length
              for (z = 0; z < l; z++)
                !1 === (c[e] ? (r[b] ? (c[e].order <= r[b].order ? c[e++] : r[b++]) : c[e++]) : r[b++]).fn.call(a, k) &&
                  k.preventDefault()
        ...
        B.prototype.getBBox = function (c, a) {
          ...
          if (!k) {
            ...
            r.isSVG &&
              ((c = k.width),
              (r = k.height),
              u && (k.height = r = { '11px,17': 14, '13px,20': 16 }[l && l.fontSize + ',' + Math.round(r)] || r),
              a &&
                ((l = a * q),
            ...
            ? ((e.ontouchstart = function (a) {
              ...
              (e.ontouchend = function (c) {
                ;(k &&
                  4 <=
                    Math.sqrt(
                      Math.pow(k - c.changedTouches[0].clientX, 2) + Math.pow(r - c.changedTouches[0].clientY, 2)
                    )) ||
                  a.call(e, c)
                b = !0
                c.preventDefault()
        ...
        B.prototype.setTextPath = function (c, a) {
          ...
          if (c && a && a.enabled) {
            b && null === b.element.parentNode
              ? ((l = !0), (b = b.destroy()))
              : b && this.removeTextOutline.call(b.parentGroup, [].slice.call(k.getElementsByTagName('tspan')))
      ...
      C(d.prototype, {
        ...
        buildText: function (a) {
          ...
          var f = function (a) {
              var k
              r.styledMode ||
                (k = /(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : d || r.style.fontSize || 12)
                    ...
                    if ('' !== k || 1 === z.length) {
                      ...
                      if (' ' !== k) {
                        ...
                        if (n) {
                          ...
                          var y = f(p)
                          if (t)
                            u = r.truncate(a, p, k, void 0, 0, Math.max(0, n - parseInt(d || 12, 10)), function (a, c) {
                            ...
                            for (; O.length; )
                              O.length &&
                                ...
                                J(p, { dy: y, x: v }),
                                m && J(p, 'style', m),
                                p.appendChild(I.createTextNode(O.join(' ').replace(/- /g, '-'))),
                                c.appendChild(p)),
              ...
              P[a + 'Setter'] = function (a, c) {
                ...
                F(r) &&
                  (g &&
                    ...
                    this.width &&
                    this.height &&
                    (r = Math.round(r * Math.min(this.width / this.imgwidth, this.height / this.imgheight))),
        ...
        symbols: {
          circle: function (a, c, r, e) {
            return this.arc(a + r / 2, c + e / 2, r / 2, e / 2, { start: 0.5 * Math.PI, end: 2.5 * Math.PI, open: !1 })
          },
          ...
          callout: function (a, c, r, e, b) {
            ...
            g && g > r
              ? b > c + l && b < c + e - l
                ? h.splice(3, 1, ['L', a + r, b - 6], ['L', a + r + 6, b], ['L', a + r, b + 6], ['L', a + r, c + e - k])
                : h.splice(3, 1, ['L', a + r, e / 2], ['L', g, b], ['L', a + r, e / 2], ['L', a + r, c + e - k])
              : g && 0 > g
              ? b > c + l && b < c + e - l
                ? h.splice(7, 1, ['L', a, b + 6], ['L', a - 6, b], ['L', a, b - 6], ['L', a, c + k])
                : h.splice(7, 1, ['L', a, e / 2], ['L', g, b], ['L', a, e / 2], ['L', a, c + k])
              : b && b > e && g > a + l && g < a + r - l
              ? h.splice(5, 1, ['L', g + 6, c + e], ['L', g, c + e + 6], ['L', g - 6, c + e], ['L', a + k, c + e])
              : b &&
                0 > b &&
                g > a + l &&
                g < a + r - l &&
        ...
        label: function (a, c, e, b, l, g, h, p, u) {
          ...
          var Y = function () {
            ...
            D &&
              (y ||
                ...
                y.addClass(('button' === u ? '' : 'highcharts-label-box') + (u ? ' highcharts-' + u + '-box' : '')),
                y.add(z),
                (a = q()),
                (c.x = a),
                (c.y = (p ? -W : 0) + a)),
          ...
          var H = function () {
            var a = G + I
            var c = p ? 0 : W
            F(U) && n && ('center' === S || 'right' === S) && (a += { center: 0.5, right: 1 }[S] * (U - n.width))
            if (a !== m.x || c !== m.y)
              m.attr('x', a),
        ...
        if (this.added) {
          ...
          if ('SPAN' === t.tagName) {
            ...
            ;(u = l !== this.oldTextWidth) &&
              !(u = l > this.oldTextWidth) &&
              ((u = this.textPxLength) || (M(t, { width: '', whiteSpace: p || 'nowrap' }), (u = t.offsetWidth)),
              (u = u > l))
            ...
            I !== this.cTT &&
              ...
              !K(e) || (e === (this.oldRotation || 0) && v === this.oldAlign) || this.setSpanRotation(e, h, p),
    ...
    f = (function () {
      ...
      d.prototype.getPosition = function (n, t, d, m) {
        ...
        n = {
          x: n
            ...
            : b.left + b.offset + (b.opposite ? ((m && g.oldChartWidth) || g.chartWidth) - b.right - b.left : 0),
          y: n
        ...
        g ||
          ...
          (this.gridLine = g =
            l
              ...
              .add(m.gridGroup)))
        if (g && (f = m.getPlotLinePath({ value: h + p, lineWidth: g.strokeWidth() * f, force: 'pass', old: n })))
      ...
      d.prototype.renderMark = function (n, d, f) {
        ...
        e &&
          ...
          p[l ? 'attr' : 'animate']({ d: this.getMarkPath(I, n, e[0], p.strokeWidth() * f, m.horiz, g), opacity: d }))
      }
      ...
      q = (function () {
        ...
        B.prototype.setOptions = function (c) {
          this.options = h(
            ...
            [B.defaultTopAxisOptions, B.defaultRightAxisOptions, B.defaultBottomAxisOptions, B.defaultLeftAxisOptions][
              this.side
            ],
            h(S[this.coll], c)
          )
        ...
        B.prototype.translate = function (c, a, k, e, b, l) {
          ...
          a
            ...
            : (b && (c = r.val2lin(c)), (c = g(e) ? h * (c - e) * z + p + h * m + (g(l) ? z * l : 0) : void 0))
          return c
        }
        ...
        B.prototype.getMinorTickPositions = function () {
          ...
          if (g && g / k < this.len / 3) {
            ...
            if (h)
              ...
              e = e.concat(this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(k), l, b, c.startOfWeek))
        ...
        B.prototype.setTickInterval = function (c) {
          ...
          a.range &&
            H(a.max) &&
            ((a.userMin = a.min = G = Math.max(a.dataMin, a.minFromRange())), (a.userMax = t = a.max), (a.range = null))
          n(a, 'foundExtremes')
        ...
        B.prototype.zoom = function (c, a) {
          ...
          n(this, 'zoom', c, function (a) {
            ...
            if (c !== e.min || k !== e.max)
              e.allowZoomOutside ||
                (H(b) && (c < p && (c = p), c > m && (c = m)), H(g) && (k < p && (k = p), k > m && (k = m))),
        ...
        B.prototype.unsquish = function () {
          ...
          a
            ? (d = !c.staggerLines && !c.step && (H(p) ? [p] : g < l(c.autoRotationLimit, 80) && c.autoRotation)) &&
        ...
        B.prototype.renderUnsquish = function () {
          ...
          e.forEach(function (a) {
            ...
            c &&
              ...
              a.shortenLabel
                ? a.shortenLabel()
                : n && !e && 'nowrap' !== g.whiteSpace && (n < c.textPxLength || 'SPAN' === c.element.tagName)
        ...
        B.prototype.getTitlePosition = function () {
          ...
          a =
            (c ? e + this.height : a) + (c ? 1 : -1) * (h ? -1 : 1) * this.axisTitleMargin + [-d, d, v.f, -d][this.side]
        ...
        B.prototype.render = function () {
          ...
          if (c.hasData() || l)
            c.minorTickInterval &&
              ...
              h.length &&
                ...
                O && (0 === c.min || c.single) && (u[-1] || (u[-1] = new E(c, -1, null, !0)), u[-1].render(-1))),
              I &&
                h.forEach(function (k, b) {
                  ...
                  0 === b % 2 &&
                    ...
                    (S = k + O),
                    (v[k].options = { from: e ? e.lin2log(S) : S, to: e ? e.lin2log(R) : R, color: I }),
                    v[k].render(),
                    (v[k].isActive = !0))
                }),
              c._addedPlotLB ||
          ...
          ;[u, d, v].forEach(function (c) {
            ...
            G(
              function () {
                for (e = k.length; e--; ) c[k[e]] && !c[k[e]].isActive && (c[k[e]].destroy(), delete c[k[e]])
              },
          ...
          m &&
            ...
            g(b.y) ? (m[m.isNew ? 'attr' : 'animate'](b), (m.isNew = !1)) : (m.attr('y', -9999), (m.isNew = !0)))
        ...
        B.prototype.drawCrosshair = function (c, a) {
          ...
          if (this.crosshair && !1 !== (H(a) || !b)) {
            b
              ? H(a) &&
                (g = l('colorAxis' !== this.coll ? a.crosshairPos : null, this.isXAxis ? a.plotX : this.len - a.plotY))
        ...
        B.prototype.hasVerticalPanning = function () {
          var c, a
          return /y/.test(
            (null === (a = null === (c = this.chart.options.chart) || void 0 === c ? void 0 : c.panning) || void 0 === a
              ? void 0
              : a.type) || ''
          )
        }
      ...
      J = (function () {
        ...
        d.prototype.normalizeTimeTickInterval = function (d, f) {
          ...
          for (
            w = 0;
            w < x.length &&
            !((f = x[w]), (C = K[f[0]]), (D = f[1]), x[w + 1] && d <= (C * D[D.length - 1] + K[x[w + 1][0]]) / 2);
            w++
          );
          ...
          if (0.5 <= d) (d = Math.round(d)), (t = x.getLinearTickPositions(d, f, H))
            ...
            (f = this.lin2log(f)),
              ...
              (d = K(
                ...
                ((n.tickPixelInterval / (C ? 5 : 1)) * (H - f)) / ((C ? w / x.tickPositions.length : w) || 1)
              )),
              (d = M(d, void 0, q(d))),
        ...
        D = (function () {
          ...
          f.prototype.render = function () {
            ...
            ;(y || !u.d) && G && G.length
              ...
              : u && (G ? (u.show(!0), u.animate({ d: G })) : u.d && (u.hide(), v && (f.label = v = v.destroy())))
          ...
          if (w && n) {
            ...
            for (d = 0; d < w.length; d += 2) {
              ...
              ;('M' !== f[0] && 'L' !== f[0]) ||
                ...
                ('M' !== e[0] && 'L' !== e[0]) ||
                ('M' !== p[0] && 'L' !== p[0]) ||
                (b && e[1] === f[1] ? ((e[1] += g), (p[1] += g)) : b || e[2] !== f[2] || ((e[2] += g), (p[2] += g)),
                m.push(['M', f[1], f[2]], ['L', h[1], h[2]], ['L', p[1], p[2]], ['L', e[1], e[2]], ['Z']))
              m.isFlat = v
            }
          }
          return m
          ...
          b = b.slice(0, m.length + 1).reduce(function (c, b, l) {
            if (!1 !== b && '' !== b) {
              ...
              p ||
                ...
                (p = t
                  .label('', 0, 0, z[y ? 'headerShape' : 'shape'] || 'callout', void 0, void 0, z.useHTML)
        ...
        b.prototype.drawTracker = function () {
          if (this.followPointer || !this.options.stickOnContact) this.tracker && this.tracker.destroy()
            ...
            if (d && h) {
              ...
              e.height =
                0 > h[1] ? Math.max(Math.abs(h[1]), p.height - Math.abs(h[1])) : Math.max(Math.abs(h[1]), p.height)
              this.tracker
                ? this.tracker.attr(e)
      ...
      f = (function () {
              ...
              e.hasCartesianSeries &&
                ...
                ((this.selectionMarker = c =
                  e.renderer
                    ...
                    .add()),
                e.styledMode || c.attr({ fill: h.selectionMarkerFill || m('#335cad').setOpacity(0.25).get() }))
        ...
        f.prototype.getCoordinates = function (b) {
          ...
          this.chart.axes.forEach(function (h) {
            e[h.isXAxis ? 'xAxis' : 'yAxis'].push({ axis: h, value: h.toValue(b[h.horiz ? 'chartX' : 'chartY']) })
          })
          return e
        }
        f.prototype.getHoverData = function (b, e, g, l, d, m) {
          ...
          f = f
            ...
            : g.filter(function (e) {
                return u.filter
                  ? u.filter(e)
                  : e.visible && !(!d && e.directTouch) && t(e.options.enableMouseTracking, !0) && e.stickyTracking
              })
          ...
          h &&
            (d && !e.noSharedTooltip
              ? ((f = g.filter(function (e) {
                  return u.filter
                    ? u.filter(e)
                    : e.visible && !(!d && e.directTouch) && t(e.options.enableMouseTracking, !0) && !e.noSharedTooltip
                })),
        ...
        f.prototype.onContainerClick = function (b) {
          ...
          e.cancelClick ||
            (g && this.inClass(b.target, 'highcharts-tracker')
              ...
              : (x(b, this.getCoordinates(b)), e.isInsidePlot(b.chartX - l, b.chartY - h) && H(e, 'click', b)))
        }
        ...
        f.prototype.pinchTranslateDirection = function (b, e, g, l, d, m, f, v) {
          ...
          V ? ((I -= 0.8 * (I - f[p][0])), 'number' === typeof O && (O -= 0.8 * (O - f[p][1])), g()) : (f[p] = [I, O])
          n || ((m[p] = z - k), (m[a] = r))
          m = n ? 1 / y : y
          d[a] = r
          d[p] = e
          ...
          if (1 === b.touches.length)
            if (
              ...
              if ('touchmove' === b.type) {
                e = this.pinchDown
                var d = e[0]
                  ? 4 <= Math.sqrt(Math.pow(e[0].chartX - b.chartX, 2) + Math.pow(e[0].chartY - b.chartY, 2))
                  : !1
              }
              t(d, !0) && this.pinch(b)
            } else e && this.reset()
    ...
    var m = d.isFirefox,
      ...
      v = (function () {
        ...
        g.prototype.proximatePositions = function () {
          ...
          this.allItems.forEach(function (e) {
            ...
            if (e.yAxis && e.points) {
              ...
              e.visible ? ((h = h ? h.plotY : e.yAxis.height), (h += m - 0.3 * d)) : (h = m + e.yAxis.height)
        ...
        g.prototype.render = function () {
          ...
          b.styledMode ||
            d
              .attr({ stroke: h.borderColor, 'stroke-width': h.borderWidth || 0, fill: h.backgroundColor || 'none' })
              .shadow(h.shadow)
          0 < v &&
            0 < n &&
            (d[d.isNew ? 'attr' : 'animate'](d.crisp.call({}, { x: 0, y: 0, width: v, height: n }, d.strokeWidth())),
            (d.isNew = !1))
          d[f ? 'show' : 'hide']()
        ...
        g.prototype.handleOverflow = function (b) {
          ...
          var v = h.maxHeight,
            ...
            q = function (a) {
              ...
              e.contentGroup.div &&
                (e.contentGroup.div.style.clip = a ? 'rect(' + f + 'px,9999px,' + (f + a) + 'px,0)' : 'auto')
            },
            C = function (a) {
              e[a] = d
                .circle(0, 0, 1.3 * k)
          ...
          b > m && !1 !== c.enabled
            ? ((this.clipHeight = n = Math.max(m - 20 - this.titleHeight - f, 0)),
              ...
              e.scroll(0),
              (b = m))
            : r && (q(), (this.nav = r.destroy()), this.scrollGroup.attr({ translateY: 1 }), (this.clipHeight = 0))
          return b
        }
        g.prototype.scroll = function (b, g) {
          ...
          0 < f &&
            ...
            [this.up, this.upTracker].forEach(function (c) {
              c.attr({ class: 1 === f ? 'highcharts-legend-nav-inactive' : 'highcharts-legend-nav-active' })
            }),
            v.attr({ text: f + '/' + m }),
        ...
        layOutTitles: function (a) {
          ...
          ;['title', 'subtitle', 'caption'].forEach(function (a) {
            ...
            if (b) {
              ...
              g.floating ||
                ('top' === d ? (c[0] = Math.ceil(c[0] + h)) : 'bottom' === d && (c[2] = Math.ceil(c[2] + h)))
            }
          }, this)
        ...
        d.prototype.renderStackTotals = function () {
          var d = this.axis.chart,
            ...
            C = (this.stackTotalGroup =
              this.stackTotalGroup || f.g('stack-labels').attr({ visibility: 'visible', zIndex: 6 }).add())
      ...
      d.prototype.animateBeforeDestroy = function () {
        ...
        f.plural.forEach(function (b) {
          d[b].forEach(function (b) {
            b.element && b.animate(K({ x: d.startXPos }, b.startYPos ? { x: b.startXPos, y: b.startYPos } : {}))
          })
        })
      }
        ...
        },
        {
          ...
          init: function (a, c) {
            ...
            e(f, function (a, c) {
              b(a) &&
                d.eventOptions[c] !== a &&
                (b(d.eventOptions[c]) && l(d, c, d.eventOptions[c]), (d.eventOptions[c] = a), E(d, c, a))
            })
          ...
          setOptions: function (a) {
            ...
            ;(!d.negativeColor && !d.negativeFillColor) ||
              d.zones ||
              ((e = { value: d[this.zoneAxis + 'Threshold'] || d.threshold || 0, className: 'highcharts-negative' }),
              c || ((e.color = d.negativeColor), (e.fillColor = d.negativeFillColor)),
              b.push(e))
            b.length && H(b[b.length - 1].value) && b.push(c ? {} : { color: this.color, fillColor: this.fillColor })
          ...
          getColor: function () {
            this.chart.styledMode
              ...
              : this.getCyclic('color', this.options.color || S[this.type].color, this.chart.options.colors)
          },
            ...
            if (!x) {
              ...
              if (n && f > n)
                if (((n = d.getFirstValidPoint(a)), g(n)))
                  ...
                  if (t) for (b = 0; b < f; b++) (e = a[b]), (y[b] = e[0]), (w[b] = e.slice(1, t + 1))
                  else
                    for (
                      B && ((G = B.indexOf('x')), (q = B.indexOf('y')), (G = 0 <= G ? G : 0), (q = 0 <= q ? q : 1)),
                        b = 0;
                      b < f;
                      b++
                    )
          ...
          getProcessedData: function (a) {
            ...
            for (l = c.length || 1; --l; )
              if (((e = f ? a(c[l]) - a(c[l - 1]) : c[l] - c[l - 1]), 0 < e && ('undefined' === typeof y || e < y)))
                var y = e
          ...
          generatePoints: function () {
            ...
            this.options.keys = a
            if (b && (l !== (e = b.length) || m))
              for (n = 0; n < e; n++) n !== h || m || (n += l), b[n] && (b[n].destroyElements(), (b[n].plotX = void 0))
            this.data = b
            this.points = p
          ...
          setClip: function (a) {
            ...
            if (!1 !== b.clip || a)
              this.group.clip(a || g ? h : c.clipRect), this.markerGroup.clip(m), (this.sharedClipKey = f)
            a ||
          ...
          animate: function (a) {
            ...
            if (!c.hasRendered)
              if (a) this.setClip(b)
                ...
                a && a.animate(d, b)
                c[e + 'm'] && c[e + 'm'].animate({ width: d.width + 99, x: d.x - (c.inverted ? 0 : 99) }, b)
              }
          },
                ...
                if (((l && 'undefined' === typeof u.enabled) || u.enabled) && !h.isNull && !1 !== h.visible) {
                  ...
                  e
                    ...
                    : w &&
                      ...
                      ((h.graphic = e = c.renderer.symbol(v, y.x, y.y, y.width, y.height, n ? u : d).add(g)),
                      this.enabledDataSorting && c.hasRendered && (e.attr({ x: h.startXPos }), (m = 'animate')))
          ...
          drawGraph: function () {
            ...
            d.forEach(function (d, g) {
              ...
              f
                ...
                : b.length && (a[k] = f = a.chart.renderer.path(b).addClass(d[1]).attr({ zIndex: 1 }).add(a.group))
              f &&
                !e &&
                ((k = { stroke: d[2], 'stroke-width': c.lineWidth, fill: (a.fillGraph && a.color) || 'none' }),
                d[3]
                  ? (k.dashstyle = d[3])
          ...
          applyZones: function () {
            ...
            if (e.length && (h || m) && n && 'undefined' !== typeof n.min) {
              ...
              e.forEach(function (e, k) {
                ...
                t = Math.max(d, g)
                n.isXAxis
                  ? ((l = { x: v ? t : w, y: 0, width: y, height: u }), I || (l.x = c.plotHeight - l.x))
                  : ((l = { x: 0, y: v ? t : w, width: u, height: y }), I && (l.y = c.plotWidth - l.y))
                v &&
                  b.isVML &&
                  (l = n.isXAxis
                    ? { x: 0, y: C ? w : t, height: l.width, width: c.chartWidth }
                    : { x: l.y - c.plotLeft - c.spacingBox.x, y: 0, width: l.height, height: c.chartHeight })
          ...
          redraw: function () {
            ...
            b &&
              ...
              b.animate({ translateX: p(e && e.left, a.plotLeft), translateY: p(d && d.top, a.plotTop) }))
            this.translate()
            this.render()
        ...
        H = (function () {
          ...
          d.prototype.render = function (d) {
            ...
            this.label
              ...
              : ((this.label = f.renderer.label(t, null, null, n.shape, null, null, n.useHTML, !1, 'stack-labels')),
                (t = {
                  r: n.borderRadius || 0,
                  text: t,
                  rotation: n.rotation,
          ...
          d.prototype.setOffset = function (d, f, n, t, q) {
            ...
            f &&
              ...
              b.isInsidePlot(f.alignAttr.x + g - this.alignOptions.x, f.alignAttr.y + n - this.alignOptions.y)
                ? f.show()
              ...
              x(!d && this.options.crop, !0) &&
                ((b = b.isInsidePlot(f.x - t + f.width, f.y) && b.isInsidePlot(f.x + t, f.y)) || f.hide()))
          }
      ...
      q.prototype.getStacks = function () {
        ...
        d.series.forEach(function (w) {
          ...
          !w.options.stacking ||
            ...
            (w.stackKey = [w.type, x(w.options.stack, ''), f ? n.top : n.left, f ? n.height : n.width].join())
        })
      }
      A.compose(d)
          ...
          for (u = 0; u < n; u++) {
            ...
            null !== G
              ? ((B.points[R] = B.points[this.index] = [x(B.cumulative, m)]),
                ...
                0 < S.index && !1 === this.singleStacks && (B.points[R][0] = B.points[this.index + ',' + y + ',0'][0]))
      ...
      C(f.prototype, {
        update: function (b, e, d, f) {
          function l() {
            ...
            t(b, !0) &&
              (a && a.element && b && b.marker && 'undefined' !== typeof b.marker.symbol && (h.graphic = a.destroy()),
      ...
      C(l.prototype, {
        ...
        update: function (b, e) {
          ...
          b = m(
            h,
            y,
            { index: 'undefined' === typeof h.index ? f.index : h.index, pointStart: g(h.pointStart, f.xData[0]) },
        ...
        { softThreshold: !1, threshold: 0 },
        {
                  ...
                  f.push(n[d]),
                    [-1, 1].forEach(function (f) {
                      ...
                      if (u)
                        for (g = t; 0 <= g && g < m; )
                          (l = u.points[g]),
                            l || (g === t ? (n[d][h] = !0) : v[g] && (I = w[d].points[g]) && (p -= I[1] - I[0])),
                            (g += b)
          ...
          getGraphPath: function (d) {
            ...
            var v = function (f, h, p) {
              ...
              'undefined' !== typeof v &&
                (t.push({ plotX: e, plotY: null === v ? g : D.getThreshold(v), isNull: l, isCliff: !0 }),
      ...
      f(
        ...
        },
        {
          ...
          getColumnMetrics: function () {
            ...
            var h = Math.min(
                Math.abs(t.transA) *
                  ((t.ordinal && t.ordinal.slope) || f.pointRange || t.closestPointRange || t.tickInterval || 1),
                t.len
              ),
              e = h * f.groupPadding,
              p = (h - 2 * e) / (v || 1)
        ...
        },
        {
          ...
          drawEmpty: function () {
            ...
            if (0 === this.total) {
              ...
              var f = this.center[1]
              this.graph ||
                (this.graph = this.chart.renderer.circle(b, f, 0).addClass('highcharts-graph').add(this.group))
              this.graph.animate(
                {
            ...
            d.points.forEach(function (g) {
              ...
              if (!g.isNull && h) {
                ...
                g.delayedRendering
                  ...
                  : (h.setRadialReference(d.center), b.styledMode || F(!0, m, e), F(!0, m, p, n), h.animate(m))
          ...
          connectorShapes: {
            fixedOffset: function (d, b, f) {
              ...
              return [
                ['M', d.x, d.y],
                f.softConnector
                  ? ['C', d.x + ('left' === d.alignment ? -5 : 5), d.y, 2 * g.x - b.x, 2 * g.y - b.y, g.x, g.y]
                  : ['L', g.x, g.y],
                ['L', b.x, b.y],
              ]
            },
          ...
          q.forEach(function (a, d) {
              ...
              h.styledMode ||
                ...
                'contrast' === u.color
                  ? ((c.contrastColor = J.getContrast(c.color || f.color)),
                    (u.color = (!K(m) && a.inside) || 0 > m || e.stacking ? c.contrastColor : '#000000'))
            ...
            !l || (g && K(p))
              ? g &&
                ...
                a.textPath &&
                  !a.useHTML &&
                  (l.setTextPath((c.getDataLabelPath && c.getDataLabelPath(l)) || c.graphic, a.textPath),
                  c.dataLabelPath && !a.textPath.enabled && (c.dataLabelPath = c.dataLabelPath.destroy())),
              ...
              : ((c.dataLabel = c.dataLabel && c.dataLabel.destroy()),
                ...
                k &&
                  ...
                  c.connectors && (1 === c.connectors.length ? delete c.connectors : delete c.connectors[d])))
          })
        })
      }
            ...
            a.dataLabel &&
              (a.visible
                ? (A[a.half].push(a),
                  ...
                  !K(e.style.width) &&
                    !K(a.options.dataLabels && a.options.dataLabels.style && a.options.dataLabels.style.width) &&
                    a.dataLabel.getBBox().width > w &&
                    (a.dataLabel.css({ width: Math.round(0.7 * w) + 'px' }), (a.dataLabel.shortened = !0)))
              ...
              if (0 < b.maxLabelDistance) {
                ...
                f.forEach(function (a) {
                  0 < a.labelDistance &&
                    ...
                    (a.distributeBox = { target: a.labelPosition.natural.y - a.top + q / 2, size: q, rank: a.y }),
              ...
              for (J = 0; J < l; J++) {
                ...
                D(e.crop, !0) &&
                  ...
                  E - k < n && 1 === g
                    ...
                    : E + k > t - n && 0 === g && ((v = Math.round(E + k - t + n)), (M[1] = Math.max(v, M[1]))),
                  0 > F - z / 2
              ...
              if ((a = c.dataLabel) && a._pos && c.visible && 0 < c.labelDistance) {
                ...
                if ((d = !x))
                  (c.connector = x =
                    ...
                    h.styledMode || x.attr({ 'stroke-width': l, stroke: O.connectorColor || c.color || '#666666' })
    ...
    m.column &&
      (m.column.prototype.alignDataLabel = function (b, d, f, h, e) {
        ...
        m &&
          ...
          g &&
            (h = { x: l.yAxis.len - h.y - h.height, y: l.xAxis.len - h.x - h.width, width: h.height, height: h.width }),
    ...
    d.prototype.hideOverlappingLabels = function (d) {
      ...
      var t = function (b) {
        ...
        if (b && (!b.alignAttr || b.placed)) {
          ...
          var l = b.parentGroup
          b.width ||
            ((d = b.getBBox()), (b.width = d.width), (b.height = d.height), (d = E.fontMetrics(null, b.element).h))
          var n = b.width - 2 * f
            ...
            c.forEach(function (a) {
              ...
              c.series.forEach(function (b) {
                if (y && !a && (!x || x.isDirty)) {
                  ...
                  D(b.dataMin) &&
                    D(b.dataMax) &&
                    ((x.startMin = Math.min(b.dataMin, x.startMin)), (x.startMax = Math.max(b.dataMax, x.startMax)))
                }
              })
              u = Math.min(
              ...
              if (!e.ordinal) {
                ...
                if ((c.series.length && p !== t.min && v !== t.max && a) || (x && p >= u && v <= q))
                  c.setExtremes(p, v, !1, !1, { trigger: 'pan' }),
                    f.resetZoomButton || h || !n.match('y') || (f.showResetZoom(), (c.displayBtn = !1)),
                    (m = !0)
                f[g] = l
              }
            })
          ...
          if (
            ...
            d && d.size && a && 'hidden' !== l && !this.isCluster
              ? (q || (f.halo = q = p.renderer.path().add(a.parentGroup)),
                ...
                (q.point = this),
                p.styledMode || q.attr(x({ fill: this.color || f.color, 'fill-opacity': d.opacity }, d.attributes)))
      ...
      x(v.prototype, {
        ...
        setVisible: function (b, d) {
          var e = this,
            ...
            l = e.visible
          var m = (e.visible = b = e.options.visible = e.userOptions.visible = 'undefined' === typeof b ? !l : b)
            ? 'show'
            : 'hide'
