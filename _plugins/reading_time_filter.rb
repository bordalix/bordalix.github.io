module ReadingTimeFilter
  ...
  def reading_time(input)
    ...
    case total_words
    when 0 .. 89
      return "30 #{second_plural} read"
    when 90 .. 269
      return "1 #{minute_singular} read"
    when 270 .. 449
      return "2 #{minute_plural} read"
    when 450 .. 629
      return "3 #{minute_plural} read"
    when 630 .. 809
      return "4 #{minute_plural} read"
    when 810 .. 990
      return "5 #{minute_plural} read"
    else
